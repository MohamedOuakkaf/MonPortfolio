...
const L = {
  ...
  Ruby:            <svg viewBox="0 0 32 32"><path d="M6 22L10 6h12l4 16-10 4z" fill="#CC342D"/><text x="16" y="21" textAnchor="middle" fill="white" fontSize="9" fontFamily="monospace" fontWeight="bold">rb</text></svg>,
  Go:              <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#00ACD7"/><text x="16" y="21" textAnchor="middle" fill="white" fontSize="11" fontFamily="monospace" fontWeight="bold">Go</text></svg>,
  Rust:            <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#CE412B"/><text x="16" y="21" textAnchor="middle" fill="white" fontSize="9" fontFamily="monospace" fontWeight="bold">Rs</text></svg>,
  Kotlin:          <svg viewBox="0 0 32 32"><path d="M4 4h12L4 16z" fill="#7F52FF"/><path d="M4 16L16 4l12 12-12 12z" fill="#C811E1" opacity=".85"/></svg>,
  Swift:           <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="8" fill="#F05138"/><path d="M24 18c0 4-3.6 7-8 7-3 0-5.5-1.3-7-3.3 1.5 1 3.4 1.6 5.5 1.3 2.3-.3 4.2-1.6 5.5-3.5-2-.5-4.2-.3-6.2.5C11.3 21.5 9 19 8 16c2.5 3.5 7 4.5 10 3-1.5-1-3.5-2.8-5-5.5 2.5 2 5.5 2.8 8 2 .6-.2 1.3-.5 1.8-1 1.4 1 2.2 2.7 1.2 3.5z" fill="white"/></svg>,
  ...
  "React Native":  <svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="2.6" fill="#61DAFB"/><ellipse cx="16" cy="16" rx="13.5" ry="5.2" fill="none" stroke="#61DAFB" strokeWidth="1.4"/><ellipse cx="16" cy="16" rx="13.5" ry="5.2" fill="none" stroke="#61DAFB" strokeWidth="1.4" transform="rotate(60 16 16)"/><ellipse cx="16" cy="16" rx="13.5" ry="5.2" fill="none" stroke="#61DAFB" strokeWidth="1.4" transform="rotate(120 16 16)"/></svg>,
  FastAPI:         <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#009688"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="7" fontFamily="monospace" fontWeight="bold">FastAPI</text></svg>,
  GraphQL:         <svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="13" fill="#E10098"/><path d="M16 5l9 5v10l-9 5-9-5V10z" fill="none" stroke="white" strokeWidth="1.5"/><circle cx="16" cy="5" r="2" fill="white"/><circle cx="25" cy="10" r="2" fill="white"/><circle cx="25" cy="22" r="2" fill="white"/><circle cx="16" cy="27" r="2" fill="white"/><circle cx="7" cy="22" r="2" fill="white"/><circle cx="7" cy="10" r="2" fill="white"/></svg>,
  "Node.js":       <svg viewBox="0 0 32 32"><path d="M16 3L4 9.5v13L16 29l12-6.5v-13z" fill="#339933"/><path d="M16 8v16M16 8l-8 4.5M16 8l8 4.5M8 12.5v7L16 24M24 12.5v7L16 24" fill="none" stroke="white" strokeWidth="1.2" opacity=".6"/></svg>,
  ...
  Elasticsearch:   <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#005571"/><circle cx="16" cy="13" r="5" fill="#FEC514"/><ellipse cx="16" cy="21" rx="7" ry="3" fill="#00BFB3"/></svg>,
  ...
  "Suricata":      <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#E8A200"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="7" fontFamily="monospace" fontWeight="bold">SURIC</text></svg>,
  "OPNsense":      <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#D94F00"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="7" fontFamily="monospace" fontWeight="bold">OPN</text></svg>,
  "Fail2Ban":      <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#8E1A1A"/><path d="M16 6l2 8h-4l2-8zm0 10a2 2 0 010 4 2 2 0 010-4z" fill="#FF6B6B"/></svg>,
  "iptables":      <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#2C3E50"/><path d="M6 10h20v4H6zm0 8h20v4H6z" fill="#27AE60" opacity=".8"/><path d="M10 10v12M22 10v12" stroke="#E74C3C" strokeWidth="1.5"/></svg>,
  "CheckPoint":    <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#CC0000"/><path d="M8 16l5 5 11-11" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  "Palo Alto":     <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#FA582D"/><path d="M8 22V10l8 6 8-6v12" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  "HAProxy":       <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#1C6EA4"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="7" fontFamily="monospace" fontWeight="bold">HA</text></svg>,
  "Squid":         <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#2C4D8C"/><path d="M8 12c0-2.2 1.8-4 4-4h8c2.2 0 4 1.8 4 4v8c0 2.2-1.8 4-4 4h-8c-2.2 0-4-1.8-4-4v-8z" fill="none" stroke="white" strokeWidth="1.5"/><path d="M12 16h8M16 12v8" stroke="white" strokeWidth="1.5" strokeLinecap="round"/></svg>,
  "NTP":           <svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="12" fill="#2980B9"/><path d="M16 8v8l5 5" stroke="white" strokeWidth="2" strokeLinecap="round"/></svg>,
  "LDAP":          <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#5D4037"/><circle cx="16" cy="11" r="3.5" fill="white"/><path d="M9 25c0-3.9 3.1-7 7-7s7 3.1 7 7" fill="white"/></svg>,
  "RADIUS":        <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#4527A0"/><circle cx="16" cy="16" r="4" fill="none" stroke="white" strokeWidth="2"/><path d="M16 12V8M16 24v-4M12 16H8M24 16h-4" stroke="white" strokeWidth="1.5" strokeLinecap="round"/></svg>,
  "Samba":         <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#CC6633"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="8" fontFamily="monospace" fontWeight="bold">SMB</text></svg>,
  "FTP / SFTP":    <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#00695C"/><path d="M8 16h16M16 10l6 6-6 6" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  "SMTP":          <svg viewBox="0 0 32 32"><rect x="3" y="8" width="26" height="16" rx="2" fill="#C0392B"/><path d="M3 10l13 8 13-8" fill="none" stroke="white" strokeWidth="1.8"/></svg>,
  "HTTP/HTTPS":    <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#1565C0"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="7" fontFamily="monospace" fontWeight="bold">HTTP</text></svg>,
  "BGP / OSPF":    <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#004D40"/><circle cx="8" cy="16" r="3" fill="#80CBC4"/><circle cx="24" cy="8" r="3" fill="#80CBC4"/><circle cx="24" cy="24" r="3" fill="#80CBC4"/><path d="M11 16l10-8M11 16l10 8" stroke="#80CBC4" strokeWidth="1.5"/></svg>,
  "VLAN / Trunking":<svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#1A237E"/><rect x="4" y="7" width="24" height="5" rx="1" fill="#5C6BC0"/><rect x="4" y="14" width="11" height="5" rx="1" fill="#3949AB"/><rect x="17" y="14" width="11" height="5" rx="1" fill="#3949AB"/><rect x="4" y="21" width="7" height="4" rx="1" fill="#283593"/><rect x="13" y="21" width="7" height="4" rx="1" fill="#283593"/><rect x="22" y="21" width="6" height="4" rx="1" fill="#283593"/></svg>,
  "Spanning Tree": <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#37474F"/><circle cx="16" cy="7" r="3" fill="#90A4AE"/><circle cx="7" cy="22" r="3" fill="#90A4AE"/><circle cx="25" cy="22" r="3" fill="#90A4AE"/><path d="M16 10v5M16 15l-9 7M16 15l9 7" stroke="#90A4AE" strokeWidth="1.5" strokeLinecap="round"/></svg>,
  "QoS":           <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#E65100"/><path d="M6 22l4-8 4 5 4-10 4 13" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  /* ── Extra Network Protocols ── */
  "TCP/IP":        <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#1565C0"/><text x="16" y="15" textAnchor="middle" fill="white" fontSize="7" fontFamily="monospace" fontWeight="bold">TCP</text><text x="16" y="25" textAnchor="middle" fill="#90CAF9" fontSize="7" fontFamily="monospace" fontWeight="bold">/IP</text></svg>,
  "IPv4 / IPv6":   <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#0D47A1"/><text x="16" y="15" textAnchor="middle" fill="white" fontSize="7" fontFamily="monospace" fontWeight="bold">IPv4</text><text x="16" y="25" textAnchor="middle" fill="#64B5F6" fontSize="7" fontFamily="monospace" fontWeight="bold">IPv6</text></svg>,
  "NAT / PAT":     <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#1B5E20"/><path d="M6 12h8l4 8h8M22 12l-4 8" fill="none" stroke="#A5D6A7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  "MPLS":          <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#4A148C"/><path d="M5 16h5l3-6 3 12 3-6h8" fill="none" stroke="#CE93D8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  "STP / RSTP":    <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#37474F"/><circle cx="16" cy="7" r="3" fill="#90A4AE"/><circle cx="7" cy="24" r="3" fill="#90A4AE"/><circle cx="25" cy="24" r="3" fill="#90A4AE"/><path d="M16 10v5M16 15l-9 9M16 15l9 9" stroke="#90A4AE" strokeWidth="1.6" strokeLinecap="round"/></svg>,
  "EIGRP":         <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#006064"/><text x="16" y="22" textAnchor="middle" fill="#80DEEA" fontSize="8" fontFamily="monospace" fontWeight="bold">EIGRP</text></svg>,
  "RIP":           <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#BF360C"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="11" fontFamily="monospace" fontWeight="bold">RIP</text></svg>,
  "ISIS":          <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#880E4F"/><text x="16" y="22" textAnchor="middle" fill="#F48FB1" fontSize="9" fontFamily="monospace" fontWeight="bold">IS-IS</text></svg>,
  "SNMP":          <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#1A237E"/><path d="M8 22c0-4.4 3.6-8 8-8s8 3.6 8 8" fill="none" stroke="#7986CB" strokeWidth="2" strokeLinecap="round"/><circle cx="16" cy="22" r="2" fill="#7986CB"/></svg>,
  "Syslog":        <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#212121"/><rect x="6" y="9" width="20" height="3" rx="1" fill="#616161"/><rect x="6" y="14" width="14" height="3" rx="1" fill="#616161"/><rect x="6" y="19" width="17" height="3" rx="1" fill="#E53935"/><rect x="6" y="24" width="10" height="3" rx="1" fill="#616161"/></svg>,
  "NetFlow":       <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#0277BD"/><path d="M6 20l5-8 4 6 3-4 4 6" fill="none" stroke="#81D4FA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  "ICMP":          <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#E65100"/><path d="M16 10v6M16 20v2" stroke="white" strokeWidth="2.5" strokeLinecap="round"/><circle cx="16" cy="16" r="10" fill="none" stroke="white" strokeWidth="1.5"/></svg>,
  "SSH / Telnet":  <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#1B2A1B"/><text x="8" y="18" fill="#4EC9B0" fontSize="11" fontFamily="monospace" fontWeight="bold">$</text><path d="M16 22h10" stroke="#4EC9B0" strokeWidth="1.8" strokeLinecap="round"/></svg>,
  "LLDP / CDP":    <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#00838F"/><circle cx="9" cy="16" r="3" fill="white" opacity=".8"/><circle cx="23" cy="16" r="3" fill="white" opacity=".8"/><path d="M12 16h8" stroke="white" strokeWidth="2" strokeDasharray="2 2"/></svg>,
  "EtherChannel":  <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#4E342E"/><path d="M6 11h20M6 16h20M6 21h20" stroke="#FFCC80" strokeWidth="2" strokeLinecap="round"/><path d="M22 8l4 8-4 8" fill="none" stroke="#FF8F00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  "WireGuard":     <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="8" fill="#88171A"/><path d="M16 6l8 5v6l-3 2-2-2v-4l-3-2-3 2v4l-2 2-3-2v-6z" fill="white" opacity=".9"/></svg>,
  "IPsec":         <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#1A237E"/><rect x="10" y="14" width="12" height="10" rx="2" fill="none" stroke="#7986CB" strokeWidth="2"/><path d="M12 14v-3a4 4 0 018 0v3" fill="none" stroke="#7986CB" strokeWidth="2"/><circle cx="16" cy="19" r="1.5" fill="#7986CB"/></svg>,
  "OSPF":          <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#004D40"/><circle cx="16" cy="16" r="6" fill="none" stroke="#80CBC4" strokeWidth="2"/><circle cx="7" cy="12" r="2.5" fill="#80CBC4"/><circle cx="25" cy="12" r="2.5" fill="#80CBC4"/><circle cx="16" cy="26" r="2.5" fill="#80CBC4"/><path d="M9 13l5 2M23 13l-5 2M16 22v-4" stroke="#80CBC4" strokeWidth="1.2"/></svg>,
  /* ── Virtualization ── */
  ...
  "Proxmox":       <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#E57000"/><path d="M8 10h7l5 6-5 6H8l5-6z" fill="white"/><path d="M17 10h7l-5 6 5 6h-7l-5-6z" fill="white" opacity=".6"/></svg>,
  "Hyper-V":       <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#0078D6"/><rect x="4" y="6" width="10" height="8" rx="1" fill="white" opacity=".9"/><rect x="18" y="6" width="10" height="8" rx="1" fill="white" opacity=".6"/><rect x="4" y="18" width="10" height="8" rx="1" fill="white" opacity=".6"/><rect x="18" y="18" width="10" height="8" rx="1" fill="white" opacity=".9"/></svg>,
  ...
  "KVM / QEMU":    <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#2E7D32"/><path d="M8 10l8 6-8 6V10zm8 0h8v12h-8" fill="none" stroke="white" strokeWidth="2" strokeLinejoin="round"/></svg>,
  "vSphere":       <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#607078"/><circle cx="16" cy="16" r="8" fill="none" stroke="white" strokeWidth="1.8"/><path d="M10 16h12M16 10c-3 2-4 4-4 6s1 4 4 6M16 10c3 2 4 4 4 6s-1 4-4 6" fill="none" stroke="white" strokeWidth="1.4"/></svg>,
  "ESXi":          <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#3D6B8C"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="9" fontFamily="monospace" fontWeight="bold">ESXi</text></svg>,
  "oVirt":         <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#CC0000"/><path d="M16 8l8 4v8l-8 4-8-4v-8z" fill="none" stroke="white" strokeWidth="2"/><circle cx="16" cy="16" r="3" fill="white"/></svg>,
  "Xen":           <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#0C479D"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="11" fontFamily="monospace" fontWeight="bold">Xen</text></svg>,
  "LXC / LXD":     <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#333"/><rect x="5" y="7" width="10" height="8" rx="1" fill="#F0C040"/><rect x="17" y="7" width="10" height="8" rx="1" fill="#F0C040" opacity=".7"/><rect x="5" y="17" width="10" height="8" rx="1" fill="#F0C040" opacity=".7"/><rect x="17" y="17" width="10" height="8" rx="1" fill="#F0C040" opacity=".5"/></svg>,
  "Vagrant":       <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#1868F2"/><path d="M8 10l8 14 8-14h-4l-4 8-4-8z" fill="white"/></svg>,
  /* ── NAS & Storage ── */
  "Synology":      <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#B5B5B5"/><rect x="6" y="8" width="20" height="5" rx="1" fill="#333"/><rect x="6" y="15" width="20" height="5" rx="1" fill="#333"/><rect x="6" y="22" width="20" height="5" rx="1" fill="#555"/><circle cx="23" cy="10.5" r="1.5" fill="#4CAF50"/><circle cx="23" cy="17.5" r="1.5" fill="#4CAF50"/><circle cx="23" cy="24.5" r="1.5" fill="#FF9800"/></svg>,
  "TrueNAS":       <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#003D6B"/><path d="M6 22V14l10-6 10 6v8l-10 4z" fill="none" stroke="#00B4E6" strokeWidth="1.8"/><path d="M6 14l10 6 10-6" stroke="#00B4E6" strokeWidth="1.4" fill="none"/><path d="M16 20v6" stroke="#00B4E6" strokeWidth="1.4"/></svg>,
  "QNAP":          <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#1C3E6B"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="9" fontFamily="sans-serif" fontWeight="bold">QNAP</text></svg>,
  "OpenMediaVault":<svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#5F9EA0"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="7" fontFamily="monospace" fontWeight="bold">OMV</text></svg>,
  "FreeNAS":       <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#003F5C"/><text x="16" y="22" textAnchor="middle" fill="#58B8D8" fontSize="7.5" fontFamily="monospace" fontWeight="bold">Free</text></svg>,
  "iSCSI":         <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#455A64"/><path d="M6 16h8M18 16h8" stroke="#90A4AE" strokeWidth="2" strokeLinecap="round"/><circle cx="16" cy="16" r="3" fill="#90A4AE"/><path d="M14 8v5M14 19v5M18 8v5M18 19v5" stroke="#90A4AE" strokeWidth="1.5" strokeLinecap="round"/></svg>,
  "NFS / CIFS":    <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#37474F"/><path d="M8 10h16M8 16h12M8 22h14" stroke="#B0BEC5" strokeWidth="2" strokeLinecap="round"/><path d="M22 19l5 3-5 3" fill="none" stroke="#78909C" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  "RAID":          <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#212121"/><rect x="5" y="7" width="8" height="18" rx="1" fill="#424242"/><rect x="12" y="7" width="3" height="18" rx="1" fill="#E53935" opacity=".7"/><rect x="19" y="7" width="8" height="18" rx="1" fill="#424242"/><circle cx="9" cy="11" r="1.5" fill="#4CAF50"/><circle cx="23" cy="11" r="1.5" fill="#4CAF50"/></svg>,
  "ZFS":           <svg viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="#1A237E"/><text x="16" y="22" textAnchor="middle" fill="#7986CB" fontSize="11" fontFamily="monospace" fontWeight="bold">ZFS</text></svg>,
...
interface IcProps { n: string; s?: number; }
const Ic = ({ n, s = 20 }: IcProps) => {
  const svg = (L as Record<string, React.ReactElement>)[n];
  ...
  return (
    <span style={{display:"inline-flex",alignItems:"center",width:s,height:s,flexShrink:0,lineHeight:0}}>
      {svg ? React.cloneElement(svg, { width: s, height: s } as any) : fb}
    </span>
  );
};
...
const CATS = [
  {
    ...
    groups:[
      { title:"Languages", items:["HTML5","CSS3","JavaScript","TypeScript","Python","PHP","Java","C++","C#","SQL","Bash","Ruby","Go","Rust","Kotlin","Swift"] },
      { title:"Frameworks & Libraries", items:["React","Next.js","Vue.js","Nuxt","Angular","Laravel","Symfony","Django","Flask","Express.js","Spring Boot","ASP.NET","Bootstrap","Tailwind","jQuery","React Native","FastAPI","GraphQL","Node.js"] },
      { title:"Databases & Storage", items:["MySQL","PostgreSQL","MariaDB","MongoDB","Redis","Oracle","SQL Server","SQLite","Elasticsearch"] },
    ],
  ...
  },
  {
    ...
    groups:[
      ...
      { title:"Network Protocols & Architecture", items:["TCP/IP","IPv4 / IPv6","VLAN / Trunking","NAT / PAT","BGP / OSPF","OSPF","EIGRP","RIP","ISIS","MPLS","STP / RSTP","EtherChannel","QoS","LLDP / CDP","SNMP","NetFlow","Syslog","ICMP","SSH / Telnet","WireGuard","IPsec","HTTP/HTTPS","FTP / SFTP","SMTP","NTP"] },
      { title:"Services & Infrastructure", items:["VPN","OpenVPN","DHCP / DNS","Active Dir.","SSL / TLS","LDAP","RADIUS","Samba","Postfix","Linux Srv","Windows Srv","HAProxy","Squid"] },
      { title:"Virtualization & Hypervisors", items:["VMware","Proxmox","Hyper-V","VirtualBox","KVM / QEMU","vSphere","ESXi","oVirt","Xen","LXC / LXD","Vagrant"] },
      { title:"NAS & Storage", items:["Synology","TrueNAS","QNAP","OpenMediaVault","FreeNAS","iSCSI","NFS / CIFS","RAID","ZFS"] },
      { title:"Firewalls & Monitoring", items:["pfSense","OPNsense","Cisco ASA","FortiGate","Palo Alto","CheckPoint","iptables","Fail2Ban","Nagios","Zabbix","Wireshark","Snort / IDS","Suricata","SIEM"] },
...
export default function Skills() {
  ...
  const handleTab = (id: string) => { setTab(id); setAnimKey(k => k + 1); };
    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .sk-in{max-width:1440px;margin:0 auto;padding:0 2rem;position:relative;z-index:1;}
        ...
        /* ── GRID: left flexible, right fixed wider ── */
        .sk-body{display:grid;grid-template-columns:1fr 500px;gap:2.4rem;align-items:start;}
        @media(max-width:1280px){.sk-body{grid-template-columns:1fr 440px;}}
        @media(max-width:1024px){.sk-body{grid-template-columns:1fr 380px;}}
        @media(max-width:860px){.sk-body{grid-template-columns:1fr;}}

        /* LEFT */
        .sk-groups{display:flex;flex-direction:column;gap:1.3rem;}
        .sk-group{background:rgba(255,255,255,.025);border:1px solid rgba(255,255,255,.065);border-radius:1rem;padding:1.4rem 1.7rem;
          opacity:0;animation:fuUp .5s cubic-bezier(.16,1,.3,1) forwards;}
        .sk-gtitle{font-family:'Syne',sans-serif;font-size:.65rem;font-weight:700;letter-spacing:.24em;text-transform:uppercase;color:rgba(248,250,252,.26);margin-bottom:.9rem;}
        .sk-chips{display:flex;flex-wrap:wrap;gap:.5rem;}

        .sk-chip{
          display:inline-flex;align-items:center;gap:.42rem;
          padding:.38rem .82rem .38rem .42rem;
          background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);
          border-radius:.55rem;cursor:default;transition:all .17s ease;
          opacity:0;animation:fuPop .3s cubic-bezier(.34,1.56,.64,1) forwards;
        }
        .sk-chip:hover{background:rgba(255,255,255,.07);border-color:rgba(255,255,255,.18);transform:translateY(-2px);}
        .sk-chip-lbl{font-size:.77rem;font-weight:500;color:rgba(248,250,252,.7);white-space:nowrap;}

        /* RIGHT — sticky so it scrolls with left content */
        .sk-right{display:flex;flex-direction:column;gap:1.5rem;position:sticky;top:2rem;}

        .sk-card{border-radius:1.2rem;padding:2.2rem 2.4rem;border:1px solid rgba(255,255,255,.06);background:rgba(255,255,255,.025);opacity:0;}
        .sk-card.v{animation:fuUp .8s cubic-bezier(.16,1,.3,1) .65s forwards;}
        .sk-card-icon{font-size:2.8rem;display:block;margin-bottom:1rem;}
        .sk-card-name{font-family:'Syne',sans-serif;font-size:1.5rem;font-weight:800;margin-bottom:.9rem;}
        .sk-card-desc{font-size:0.85rem;font-weight:300;color:rgba(248,250,252,.52);line-height:1.8;}
        .sk-card-stats{margin-top:1.4rem;padding-top:1.2rem;border-top:1px solid rgba(255,255,255,.07);display:flex;gap:2rem;}
        .sk-stat{display:flex;flex-direction:column;gap:.15rem;}
        .sk-stat-n{font-family:'Syne',sans-serif;font-size:2.1rem;font-weight:800;line-height:1;}
        .sk-stat-l{font-size:.68rem;color:rgba(248,250,252,.3);letter-spacing:.08em;text-transform:uppercase;}

        .sk-tpanel{border-radius:1.2rem;padding:2rem 2.2rem;border:1px solid rgba(255,255,255,.06);background:rgba(255,255,255,.025);opacity:0;text-align:center;}
        .sk-tpanel.v{animation:fuUp .8s cubic-bezier(.16,1,.3,1) .82s forwards;}
        .sk-tpanel-title{font-family:'Syne',sans-serif;font-size:.68rem;font-weight:700;letter-spacing:.24em;text-transform:uppercase;color:rgba(248,250,252,.26);margin-bottom:1.4rem;}
        .sk-tgrid{display:grid;grid-template-columns:repeat(5,1fr);gap:.6rem;justify-items:center;}

        @media(max-width:1400px){.sk-tgrid{grid-template-columns:repeat(4,1fr);}}
        @media(max-width:1200px){.sk-tgrid{grid-template-columns:repeat(3,1fr);}}
        @media(max-width:480px){.sk-tgrid{grid-template-columns:repeat(2,1fr);}}

        .sk-tool{
          display:flex;flex-direction:column;align-items:center;justify-content:center;gap:.4rem;
          width:100%;aspect-ratio:1/1;max-width:85px;padding:.5rem;
          background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.065);
          border-radius:.8rem;transition:all .17s ease;cursor:default;
          opacity:0;animation:fuPop .3s cubic-bezier(.34,1.56,.64,1) forwards;
        }
        .sk-tool:hover{transform:translateY(-2px);}
        .sk-tool-lbl{font-size:.84rem;font-weight:500;color:rgba(248,250,252,.65);white-space:nowrap;}
      `}</style>
      ...
      <section className="sk" ref={ref}>
        ...
        <div className="sk-in">
          ...
          <div className="sk-body">
            {/* LEFT */}
            <div className="sk-groups" key={`groups-${animKey}`}>
              {cat.groups.map((grp, gi) => (
                <div className="sk-group" key={grp.title} style={{animationDelay:`${gi*0.06}s`}}>
                  <p className="sk-gtitle">{grp.title}</p>
                  <div className="sk-chips">
                    {grp.items.map((name, ii) => (
                      <div key={name} className="sk-chip"
                        style={{animationDelay:`${gi*0.06+0.07+ii*0.025}s`}}>
                        <Ic n={name} s={20}/>
            ...
            <div className="sk-right">
              ...
              <div className={`sk-tpanel${vis?" v":""}`}
                ...
                <div className="sk-tgrid">
                  {cat.tools.map((t, i) => (
                    <div key={t} className="sk-tool"
                      style={{animationDelay:`${0.1+i*0.05}s`,borderColor:`${cat.color}1a`}}
                      onMouseEnter={(e: React.MouseEvent<HTMLDivElement>)=>{e.currentTarget.style.background=cat.color+"12";e.currentTarget.style.borderColor=cat.color+"45";}}
                      onMouseLeave={(e: React.MouseEvent<HTMLDivElement>)=>{e.currentTarget.style.background="";e.currentTarget.style.borderColor=cat.color+"1a";}}>
                      <Ic n={t} s={24}/>
                      <span className="sk-tool-lbl" style={{fontSize: t.length > 8 ? '0.65rem' : '0.72rem'}}>{t}</span>
                    </div>
                  ))}
                </div>
              </div>
